...
public class AddProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductImagesRef = FirebaseStorage.getInstance().getReference().child("Product Image/cake");
        ProductRef = FirebaseDatabase.getInstance().getReference().child("Products/cake");
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AddProduct.this, "Product Image Url Saved ", Toast.LENGTH_SHORT).show();
        ...
        ProductRef.child(ProductRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(AddProduct.this,CategoryActivity.class);
